<label for="country">What country are you based in?</label>
<select id="selectCountry" name="country" class="form-control">
    ...
    <option value="AQ" @if($country === 'AQ') selected @endif>Antarctica</option>
    ...
    <option value="BO" @if($country === 'BO') selected @endif>Bolivia, Plurinational State of</option>
    ...
    <option value="BV" @if($country === 'BV') selected @endif>Bouvet Island</option>
    <option value="BR" @if($country === 'BR') selected @endif>Brazil</option>
    <option value="IO" @if($country === 'IO') selected @endif>British Indian Ocean Territory</option>
    <option value="BN" @if($country === 'BN') selected @endif>Brunei Darussalam</option>
    ...
    <option value="CG" @if($country === 'CG') selected @endif>Congo</option>
    <option value="CD" @if($country === 'CD') selected @endif>Congo, the Democratic Republic of the</option>
    ...
    <option value="CI" @if($country === 'CI') selected @endif>Côte d'Ivoire</option>
    ...
    <option value="FK" @if($country === 'FK') selected @endif>Falkland Islands (Malvinas)</option>
    ...
    <option value="HM" @if($country === 'HM') selected @endif>Heard Island and McDonald Islands</option>
    <option value="VA" @if($country === 'VA') selected @endif>Holy See (Vatican City State)</option>
    ...
    <option value="IR" @if($country === 'IR') selected @endif>Iran, Islamic Republic of</option>
    ...
    <option value="KP" @if($country === 'KP') selected @endif>Korea, Democratic People's Republic of</option>
    <option value="KR" @if($country === 'KR') selected @endif>Korea, Republic of</option>
    <option value="KW" @if($country === 'KW') selected @endif>Kuwait</option>
    <option value="KG" @if($country === 'KG') selected @endif>Kyrgyzstan</option>
    <option value="LA" @if($country === 'LA') selected @endif>Lao People's Democratic Republic</option>
    ...
    <option value="MO" @if($country === 'MO') selected @endif>Macao</option>
    <option value="MK" @if($country === 'MK') selected @endif>Macedonia, the former Yugoslav Republic of</option>
    ...
    <option value="MX" @if($country === 'MK') selected @endif>Mexico</option>
    <option value="FM" @if($country === 'FM') selected @endif>Micronesia, Federated States of</option>
    <option value="MD" @if($country === 'MD') selected @endif>Moldova, Republic of</option>
    ...
    <option value="MM" @if($country === 'MM') selected @endif>Myanmar</option>
    <option value="NA" @if($country === 'NA') selected @endif>Namibia</option>
    <option value="NR" @if($country === 'NR') selected @endif>Nauru</option>
    ...
    <option value="PS" @if($country === 'PS') selected @endif>Palestinian Territory, Occupied</option>
    ...
    <option value="PN" @if($country === 'PN') selected @endif>Pitcairn</option>
    ...
    <option value="RU" @if($country === 'RU') selected @endif>Russian Federation</option>
    <option value="RW" @if($country === 'RW') selected @endif>Rwanda</option>
    <option value="BL" @if($country === 'BL') selected @endif>Saint Barthélemy</option>
    <option value="SH" @if($country === 'SH') selected @endif>Saint Helena, Ascension and Tristan da Cunha</option>
    ...
    <option value="MF" @if($country === 'MF') selected @endif>Saint Martin (French part)</option>
    ...
    <option value="ST" @if($country === 'ST') selected @endif>Sao Tome and Principe</option>
    ...
    <option value="SX" @if($country === 'SX') selected @endif>Sint Maarten (Dutch part)</option>
    ...
    <option value="SS" @if($country === 'SS') selected @endif>South Sudan</option>
    ...
    <option value="SJ" @if($country === 'SJ') selected @endif>Svalbard and Jan Mayen</option>
    ...
    <option value="SY" @if($country === 'SY') selected @endif>Syrian Arab Republic</option>
    <option value="TW" @if($country === 'TW') selected @endif>Taiwan, Province of China</option>
    <option value="TJ" @if($country === 'TJ') selected @endif>Tajikistan</option>
    <option value="TZ" @if($country === 'TZ') selected @endif>Tanzania, United Republic of</option>
    ...
    <option value="TK" @if($country === 'TK') selected @endif>Tokelau</option>
    <option value="TO" @if($country === 'TO') selected @endif>Tonga</option>
    <option value="TT" @if($country === 'TI') selected @endif>Trinidad and Tobago</option>
    ...
    <option value="UM" @if($country === 'UM') selected @endif>United States Minor Outlying Islands</option>
    ...
    <option value="VE" @if($country === 'VE') selected @endif>Venezuela, Bolivarian Republic of</option>
    <option value="VN" @if($country === 'VN') selected @endif>Viet Nam</option>
    <option value="VG" @if($country === 'VG') selected @endif>Virgin Islands, British</option>
    <option value="VI" @if($country === 'VI') selected @endif>Virgin Islands, U.S.</option>
